...
public class ReceiptTest {
    ...
    public void testReceiptConstructor() {
        ...
        Amount priceWithVat = new Amount(50);
        Amount priceWithOutDiscount = new Amount(55);
        Amount priceSubDiscount = new Amount(5);
        List<SaleItem> list = new ArrayList<>();
        Amount change = new Amount(45);
        Receipt rece = new Receipt(time, priceWithVat, change, VAT, list,priceWithOutDiscount,priceSubDiscount);
        assertNotNull(rece);
        assertEquals(rece.getPaid().getAmount(), 50.00 );
