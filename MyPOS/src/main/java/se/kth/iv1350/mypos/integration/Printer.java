...
public class Printer {
    ...
    */
    public void printReceipt(Receipt receipt){
        ...
        System.out.println();
        System.out.printf("Total:  %.10s SEK%n", receipt.getTotal());
        System.out.printf("Discount:  %.10s SEK%n", receipt.getDiscountSaved());
        System.out.printf("Paid:  %.10s SEK%n", receipt.getPaid());
