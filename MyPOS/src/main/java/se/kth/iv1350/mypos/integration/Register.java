...
public class Register {
    private static final Register INSTANCE = new Register(new Amount(0));
    ...
    */
    private Register(Amount valueInRegister){
    ...
    */
    public Register AddRegister(FinalSaleInfo finalSale){
        valueInRegister = valueInRegister.add(finalSale.cashUsed);
        valueInRegister = valueInRegister.sub(finalSale.getChange());
